...
{
    BOOST_MESSAGE("Start test_map_allocate...");
    ...
    BOOST_MESSAGE("Checks true...");
    BOOST_CHECK_THROW(m.insert({10, factorial(10)}), std::bad_alloc);
    BOOST_MESSAGE("Stop test_map_allocate...");
}

BOOST_AUTO_TEST_CASE(test_vector_allocate)
{
    BOOST_MESSAGE("Start test_vector_allocate...");
    ...
    BOOST_MESSAGE("Stop test_vector_allocate...");
}

BOOST_AUTO_TEST_CASE(test_my_vector_allocate)
{
    BOOST_MESSAGE("Start test_my_vector_allocate...");
    ...
    BOOST_MESSAGE("Check equal collections true...")
    BOOST_CHECK_THROW(v.push_back(111), std::bad_alloc);
    BOOST_MESSAGE("Stop test_my_vector_allocate...");
}
